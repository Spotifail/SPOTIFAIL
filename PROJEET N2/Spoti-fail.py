...
def deuxieme_fenetre():
    ...
    fenetre2['bg'] = '#D46A6A' #bg = background
    fenetre2.geometry(f"{fenetre.winfo_width()}x{fenetre.winfo_height()}+{x}+{y}")
    fenetre2.title('SPOTI-FAIL')

    button = Button(fenetre2, text="retour", command=retour1)
    ...
    play = Button(fenetre2,image=image_redi3)
    ...
    button2 = Button(fenetre2,text='playlist', width=16, height=8, command=troisieme_fenetre)
    button2.place(x='50',y='220') 

    button3 = Button(fenetre2,text='favoris',width=16, height=8, command=quatrieme_fenetre)
    ...
    fenetre2.protocol("WM_DELETE_WINDOW", dans_fenetre2)
def dans_fenetre2():
...
def troisieme_fenetre():
    ...
    play = Button(fenetre3,image=play_image, width=50,height=50)

    previous_image = PhotoImage(file = r"C:\Users\EMANY MAKAP\Desktop\PROJEET N2\image\next,previous, pause\previous.png")
    previous = Button(fenetre3,image=previous_image, width=50,height=50)

    next_image = PhotoImage(file = r"C:\Users\EMANY MAKAP\Desktop\PROJEET N2\image\next,previous, pause\next.png")
    next = Button(fenetre3,image=next_image, width=50,height=50)
    previous.place(x=600, y=670)
    play.place(x=700, y=670)
    next.place(x=800, y=670)
    ...
    button2 = Button(fenetre3,text='playlist', width=16, height=8, command=troisieme_fenetre)
    button2.place(x='50',y='220') 

    button3 = Button(fenetre3,text='favoris',width=16, height=8, command=quatrieme_fenetre)
    button3.place(x='50',y='400') 
    ...
    son_barre_horizontale= Button(fenetre3, text="bla", width=30, height=30)
...
photo16 = photo16.subsample(2, 2)
    ...
    #boutons
button1 = Button(fenetre, text='menu', width=16, height=8, command=deuxieme_fenetre) 
button1.place(x='50',y='50') 
...
son_barre_horizontale= Button(fenetre, text="bla", width=30, height=30)
